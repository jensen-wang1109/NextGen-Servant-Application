...
<?php 
    ...
    if(isset($_POST['save'])) {
        ...
        //insert into jenis_pemusik
        mysqli_query($con, "INSERT INTO jenis_pemusik VALUES (NULL, '$namaJenisPemusik')");
...
<head>
    ...
    <title>| FORM DAFTAR JENIS PELAYANAN MUSIK</title>
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                <h3 style="color: black;">Form Daftar Jenis Pelayanan Musik</h3>
            ...
            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;">
                <a class="btn btn-danger" href="jadwal_pemusik.php" onclick="return confirm('Apakah yakin ingin membatalkan proses penginputan data?');"  role="button"><i class="fas fa-arrow-left"></i>&ensp;Back</a>
            </div>
                ...
                <form style="color: black; padding-bottom: 50px; background-color: white;" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="kiri" style="width: 45%; margin-left: 20px; float:left; margin-right: 35px; padding-top:30px;">
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            <input type="text" class="form-control" placeholder="Masukkan Nama Jenis Pelayanan Musik" name="inputnamajenispemusik" style="color: black;" required>
                        </div>
                    </div>
                    ...
                    <div class="kanan" style="width: 45%; float: left; margin-left: 25px; margin-top:30px; text-align: right; height: 200px; overflow:auto;">
                        <table class="table table-hover table-striped" style="color:black;">
                            <thead style="text-align: center;">
                                <tr>
                                    <th scope="col">No</th>
                                    <th scope="col">Nama Jenis Pelayanan Musik</th>
                            ...
                            <?php 
                                ...
                                $query = mysqli_query($con, "SELECT * FROM jenis_pemusik");
                                ...
                                while($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr scope="row">
                                        ...
                                        <td style="text-align: center;">
                                            <?php
                                                echo $row['nama_jenis_pemusik'];
                                            ?>
                                        </td>
                                        <td style="text-align: center;">
                                            <a href="form_jenis_pemusik_edit.php?jenisPemusikId=<?php echo $row['jenis_pemusik_id']; ?>" class="btn btn-warning btn-sm" title="Edit">
