    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            ...
            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;" id="tambah">
                <a class="btn btn-success" href="form_renungan.php" role="button"><i class="fas fa-plus"></i>&ensp;Add Renungan</a>
            </div>
                    ...
                    <table id="table" class="table table-hover table-striped" style="color:black;">
                        <thead style="text-align: center;">
                            <tr>
                                <!-- <th scope="col"></th> -->
                                <th scope="col">No</th>
                                <th scope="col">Tanggal Renungan</th>
                                <th scope="col">Tema Renungan</th>
                                <th scope="col">Full Renungan</th>
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($con, "SELECT *, DATE_FORMAT(tanggal_renungan, '%d %M %Y') AS tanggal_renungan FROM renungan");

                            while($row = mysqli_fetch_array($query)) {
                                ?>
                                <tr scope="row">
                                    <td style="text-align: right; width:5%;"><?php echo $nomor; ?>.</td>
                                    <td style="text-align: center; width:20%;" ><?php echo $row['tanggal_renungan']; ?></td> 
                                    <td><?php echo $row['tema_renungan']; ?></td>
                                    <td style="text-align: center; width:15%;" >
                                        <a href="renungan_full.php?renunganId=<?php echo $row['renungan_id'];?>" class="btn btn-info btn-sm" title="View Renungan">
                                            <i class="far fa-file-alt"></i>
                                        </a>
                                    </td>
                                    <td style="text-align: center; width:10%;" class="ed">
                                        <a href="form_renungan_edit.php?renunganId=<?php echo $row['renungan_id'];?>" class="btn btn-warning btn-sm" title="Edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="renungan_delete.php?renunganId=<?php echo $row['renungan_id'];?>" onclick="return confirm('Yakin menghapus data?')" class="btn btn-danger btn-sm" title="Delete">
