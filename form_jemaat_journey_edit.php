...
<?php 
    ...
    $dataJabatanJemaat = mysqli_query($con, "SELECT j.fullname_jemaat, ja.nama_jabatan, jj.* FROM jemaat j JOIN jabatan_jemaat jj ON j.jemaat_id = jj.jemaat_id JOIN jabatan ja ON jj.jabatan_id = ja.jabatan_id WHERE j.jemaat_id = '$paramJemaatId' AND ja.jabatan_id = '$paramJabatanId'");
    $rowDataJabatanJemaat = mysqli_fetch_array($dataJabatanJemaat);

    $jabatanJemaatId = $rowDataJabatanJemaat['jabatan_jemaat_id'];
    ...
    if(isset($_POST['update'])) {
        ...
        //update jabatan jemaat
        mysqli_query($con, "UPDATE jabatan_jemaat SET start_date = '$start_dt', end_date = '$end_dt' WHERE jabatan_jemaat_id = '$jabatanJemaatId'");
...
<head>
    ...
    <title>| FORM EDIT JOURNEY JEMAAT</title>
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                <h3 style="color: black;">Form Edit Journey <?php echo $rowDataJabatanJemaat['fullname_jemaat']; ?></h3>
                ...
                <p style="display: inline;">&ensp; / &ensp;</p>
                <a href="jemaat_journey.php?jemaatId=<?php echo $paramJemaatId; ?>" style="display: inline;">Journey Jemaat</a>
                <p style="display: inline;">&ensp; / &ensp;</p>
                <a href="form_jemaat_journey_edit.php?jemaatId=<?php echo $paramJemaatId; ?>&jabatanId=<?php echo $paramJabatanId; ?>" style="display: inline;">Form Edit Journey <?php echo $rowDataJabatanJemaat['fullname_jemaat']; ?></a>
            </div>

            <div class="clean"></div>

            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;" id="tambah">
                <a class="btn btn-danger" href="jemaat_journey.php?jemaatId=<?php echo $rowDataJabatanJemaat['jemaat_id']; ?>" onclick="return confirm('Apakah yakin ingin membatalkan proses mengedit data?');"  role="button"><i class="fas fa-minus"></i>&ensp;Cancel</a>
            </div>
                ...
                <form style="color: black; padding-bottom: 50px; background-color: white;" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="kiri" style="width: 45%; margin-left: 20px; float:left; margin-right: 35px; padding-top:30px;">
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            ...
                            <select class="form-select" name="inputjabatan" aria-label="Default select example" required disabled>
                                <option hidden>Pilih Jabatan</option>
                                <?php
                                    while($list_jabatan=mysqli_fetch_array($jabatan_jemaat)) {
                                        ?>
                                            <option value="<?php echo $list_jabatan['jabatan_id']; ?>" <?php if($rowDataJabatanJemaat['nama_jabatan'] == $list_jabatan['nama_jabatan']) { ?> selected="selected"<?php } ?>><?php echo $list_jabatan['nama_jabatan']; ?></option>
                                        <?php
                                    }
                                ?>
                            </select>
                        ...
                        <div class="tgl-kiri" style="width: 45%; float:left;">
                            ...
                            <div class="input-group mb-3" style="padding-bottom: 10px;">
                                <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tglmasukjabatan" style="color: black;" value="<?php echo $rowDataJabatanJemaat['start_date']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="tgl-kanan" style="width: 45%; float:right;">
                            ...
                            <div class="input-group mb-3" style="padding-bottom: 10px;">
                                <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tglakhirjabatan" style="color: black;" value="<?php echo $rowDataJabatanJemaat['end_date']; ?>">
                            </div>
                        </div>
