...
<?php 
    ...
    $edit_renungan = mysqli_query($con, "SELECT * FROM renungan WHERE renungan_id = '$paramRenunganId'");

    $row_edit_renungan = mysqli_fetch_array($edit_renungan);    
    ...
    if(isset($_POST['update'])) {
        ...
        //update renungan
        mysqli_query($con, "UPDATE renungan SET tanggal_renungan = '$tglRenungan', tema_renungan = '$temaRenungan', preview_renungan = '$isiRenungan', ref_user_id = '$userId' WHERE renungan_id = '$paramRenunganId'");
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                <h3 style="color: black;">Form Edit Renungan</h3>
                ...
                <p style="display: inline;">&ensp; / &ensp;</p>
                <a href="form_renungan_edit.php?renunganId=<?php echo $paramRenunganId;?>" style="display: inline;">Form Edit Renungan</a>
            </div>

            <div class="clean"></div>

            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;" id="tambah">
                <a class="btn btn-danger" href="renungan.php" onclick="return confirm('Apakah yakin ingin membatalkan proses mengedit data?');"  role="button"><i class="fas fa-minus"></i>&ensp;Cancel</a>
            </div>
                ...
                <form style="color: black; padding-bottom: 50px; background-color: white;" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="kiri" style="width: 60%; margin-left: 20px; float:left; margin-right: 35px; padding-top:30px;">
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="inputtglrenungan" style="color: black;" value="<?php echo $row_edit_renungan['tanggal_renungan']; ?>" required>
                        </div>
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Tema Renungan" name="inputtemarenungan" style="color: black;" value="<?php echo $row_edit_renungan['tema_renungan']; ?>" required>
                        </div>
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            ...
                            <textarea cols="50" rows="15" class="form-control" style="color: black;" placeholder="Masukkan Isi Renungan" name="inputisirenungan" required><?php echo $row_edit_renungan['preview_renungan']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <center style="background-color: white; margin-top: 50px;">
                        <input type="submit" class="btn btn-success" value="Update Renungan" name="update">
                    </center>
                </form>
            </div>
        </div>
