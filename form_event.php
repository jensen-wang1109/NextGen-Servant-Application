...
<?php 
    ...
    if(isset($_POST['save'])) {
        ...
        //insert event
        mysqli_query($con, "INSERT INTO event VALUES (NULL, '$startDt', '$endDt', '$temaEvent', '$detailEvent', '$userId')");
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                <h3 style="color: black;">Form Event</h3>
                ...
                <p style="display: inline;">&ensp; / &ensp;</p>
                <a href="form_event.php" style="display: inline;">Form Event</a>
            </div>

            <div class="clean"></div>

            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;" id="tambah">
                <a class="btn btn-danger" href="event.php" onclick="return confirm('Apakah yakin ingin membatalkan proses penginputan data?');"  role="button"><i class="fas fa-minus"></i>&ensp;Cancel</a>
            </div>
                ...
                <form style="color: black; padding-bottom: 50px; background-color: white;" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="kiri" style="width: 30%; margin-left: 20px; float:left; margin-right: 35px; padding-top:30px;">
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="inputtglstartevent" style="color: black;" required>
                        </div>

                        <h6><b>Tanggal Selesai Event</b></h6>
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="inputtglendevent" style="color: black;" required>
                        </div>
                    ...
                    <div class="kanan" style="width: 60%; float: left; margin-left: 25px; padding-top:30px;">
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Tema Event" name="inputtemaevent" style="color: black;" required>
                        </div>
                        ...
                        <div class="input-group mb-3" style="padding-bottom: 10px;">
                            ...
                            <textarea cols="50" rows="15" class="form-control" style="color: black;" placeholder="Masukkan Detail Event" name="inputdetailevent" required></textarea>
                        </div>
                    </div>
                    <div class="clean"></div>

                    <center style="background-color: white; margin-top: 50px;">
                        <input type="submit" class="btn btn-success" value="Save Event" name="save">
                    </center>
                </form>
            </div>
        </div>
