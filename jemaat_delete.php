...
<?php 
    ...
    mysqli_query($con, "DELETE FROM jabatan_jemaat WHERE jemaat_id = '$paramJemaatId'");
    mysqli_query($con, "DELETE FROM jemaat WHERE jemaat_id = '$paramJemaatId'");

    echo "<script>alert('Data sudah dihapus');
    document.location = 'jemaat.php'
    </script>";
?>