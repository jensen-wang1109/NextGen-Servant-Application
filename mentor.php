                ...
                <div class="col-sm-12" style="margin-top: 20px; margin-bottom: 20px;  overflow:auto;">
                    ...
                    <table id="table" class="table table-hover table-striped" style="color:black;">
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($con, "SELECT j.*, DATE_FORMAT(j.dob_jemaat, '%d %M %Y') AS dob_jemaat, jj.* FROM jemaat j JOIN jabatan_jemaat jj ON j.jemaat_id = jj.jemaat_id JOIN jabatan ja ON jj.jabatan_id = ja.jabatan_id WHERE ja.nama_jabatan = 'MENTOR';");
