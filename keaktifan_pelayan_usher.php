...
<head>
    ...
    <title>| KEAKTIFAN PELAYAN USHER</title>
    ...
    <?php 
        $query = mysqli_query($con, "SELECT j.fullname_jemaat, COUNT(j.fullname_jemaat) AS total_melayani FROM usher u JOIN jemaat j ON u.jemaat_id = j.jemaat_id GROUP BY j.fullname_jemaat ORDER BY total_melayani DESC LIMIT 20");
    ?>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Keaktifan Pelayan Usher (Top 20)',
          is3D: true,
        };
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                ...
                <a href="keaktifan_pelayan_usher.php" style="display: inline;">Keaktifan Pelayan Usher</a>
            </div>
