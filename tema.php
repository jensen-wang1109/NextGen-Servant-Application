    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            ...
            <div class="row" style="font-family: Poppins; float:left; margin-right:20px;" id="tambah">
                <a class="btn btn-success" href="form_tema_bulanan.php" role="button"><i class="fas fa-plus"></i>&ensp;Add Tema Bulanan</a>
            </div>
                    ...
                    <table id="table" class="table table-hover table-striped" style="color:black;">
                        <thead style="text-align: center;">
                            <tr>
                                ...
                                <th scope="col">Preview Tema Bulanan</th>
                                <th scope="col">Detail Tema Mingguan</th>
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($con, "SELECT * FROM tema_bulanan");
                            ...
                            while($row = mysqli_fetch_array($query)) {
                                ...
                                <tr scope="row">
                                    ...
                                    <td><?php echo $row['judul_tema_bulanan']; ?></td> 
                                    <td><?php echo $row['preview_tema_bulanan']; ?></td>
                                    <td style="text-align: center; width:10%;">
                                        <a href="tema_mingguan.php?temaBulananId=<?php echo $row['tema_bulanan_id']; ?>" class="btn btn-info btn-sm" title="View Tema Mingguan">
                                            <i class="fas fa-info-circle"></i>
                                        </a>
                                    </td>
                                    <td style="text-align: center; width:10%;" class="ed">
                                        <a href="form_tema_bulanan_edit.php?temaBulananId=<?php echo $row['tema_bulanan_id']; ?>" class="btn btn-warning btn-sm" title="Edit">
                                        <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="tema_bulanan_delete.php?temaBulananId=<?php echo $row['tema_bulanan_id']; ?>" onclick="return confirm('Yakin menghapus data?')" class="btn btn-danger btn-sm" title="Delete"><i class="fas fa-trash-alt"></i>
                                        </a>
                                    </td>
                                </tr>
