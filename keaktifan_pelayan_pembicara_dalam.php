...
<head>
    ...
    <title>| KEAKTIFAN PELAYAN PENGKHOTBAH DALAM</title>
    ...
    <?php 
        $query = mysqli_query($con, "SELECT j.fullname_jemaat, COUNT(fullname_jemaat) AS total_melayani FROM pengkhotbah p JOIN jemaat j ON p.jemaat_id = j.jemaat_id WHERE p.jemaat_id IS NOT NULL GROUP BY fullname_jemaat ORDER BY total_melayani DESC LIMIT 20");
    ?>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Nama Pengkhotbah Dalam', 'Total Melayani'],
          <?php
        ...
        var options = {
          title: 'Keaktifan Pelayan Pengkhotbah Dalam (Top 20)',
          is3D: true,
        };
    ...
    <div id="wrapper">
        ...
        <div class="container fluid">
            <div class="page_head" style="margin-bottom: 50px;">
                ...
                <a href="keaktifan_pelayan_pembicara_dalam.php" style="display: inline;">Keaktifan Pelayan Pengkhotbah Dalam</a>
            </div>
